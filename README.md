...
A full-stack movie discovery application that allows users to browse trending movies, search for films, view detailed information, and watch trailers. The project is built with a React frontend and a FastAPI backend, powered by The Movie Database (TMDB) API.
